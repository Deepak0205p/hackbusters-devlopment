...
from apps.shared.agent.tools import tool_registry
from apps.shared.agent.self_correction import self_correction_engine
from apps.shared.sovereignty.tamper_log import audit_log
from apps.shared.rag.cache import response_cache
from apps.shared.rag.grounding import grounding_verifier
...
class ReActAgentEngine:
    ...
    async def execute_task(
        ...
        if not has_attachments and not role and not force_refresh and not has_history:
            ...
            if cached is not None:
                ...
                yield {
                    ...
                    "routed_by": "Local Response Cache (Persistent XAMPP MySQL)",
                    "confidence": 100
                }
                ...
                yield {
                    ...
                    "routed_by": "Response Cache (XAMPP MySQL)",
                    "confidence": 100,
        ...
        from apps.shared.models.compute_backends import get_backend_for_model
